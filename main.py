...
@click.option('--velocidad', default=None, help='Nueva velocidad del viento para la ciudad')
@click.option('--humedad', default=None, help='Nueva humedad para la ciudad')
@click.option('--descripcion', default=None, help='Nueva descripción del clima para la ciudad')
